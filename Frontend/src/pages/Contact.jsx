...
const SearchableSelect = ({ label, options, value, onChange, placeholder, icon: Icon, disabled, isPhoneSelector }) => {
  ...
  const filteredOptions = useMemo(() => {
    return options.filter(opt => {
      const searchStr = typeof opt === 'string' ? opt : `${opt.name} ${opt.code}`;
  ...
  return (
    <div className="space-y-2 relative" ref={containerRef}>
      ...
      <div
        ...
        className={`w-full px-4 py-3 rounded-xl border flex items-center justify-between cursor-pointer transition-all ${disabled ? 'bg-slate-50 border-slate-100 opacity-50' : 'bg-white border-slate-200 hover:border-blue-300'
            ...
            <div className="max-h-60 overflow-y-auto">
              {filteredOptions.length > 0 ? (
                filteredOptions.map((opt) => {
                  ...
                  const labelStr = isString ? opt : `${opt.flag} ${opt.name} (${opt.code})`;
                  ...
                  return (
                    ...
                    >
                      ...
                      {(isString ? value === opt : value === opt.code) && <Check className="w-4 h-4 text-blue-600 flex-shrink-0" />}
                    </div>
                  );
                })
              ) : (
                <div className="px-4 py-3 text-sm text-slate-400 italic text-center">No results found</div>
              )}
            </div>
          </motion.div>
        )}
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.phone.length < 8) {
      ...
      errorMsg.className = "fixed bottom-4 right-4 bg-orange-600 text-white px-6 py-3 rounded-lg shadow-xl z-50 animate-bounce";
    ...
    try {
      ...
      setIsSubmitted(true);
      setFormData({
        fullName: '', email: '', countryCode: '+91', phone: '', dob: '', age: '',
                ...
                <form onSubmit={handleSubmit} className="space-y-10">
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      {/* Searchable Phone Prefix Selector */}
                  ...
                  <div>
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      ...
                      <div className="md:col-span-2 space-y-2">
                        ...
                        <input type="hidden" name="course" value={formData.course} required />
                          ...
                          {!formData.domain ? (
                            ...
                            domainData[formData.domain].map(course => (
                              <button
                                ...
                                className={`px-4 py-3 rounded-xl border text-sm font-medium transition-all text-left ${formData.course === course
                  ...
                  <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-6 border-t border-slate-100">
                    ...
                    <button
                      ...
                      className={`w-full md:w-auto px-10 py-4 rounded-2xl font-bold flex items-center justify-center gap-3 transition-all ${isLoading || !formData.eduLevel || !formData.domain || !formData.course
